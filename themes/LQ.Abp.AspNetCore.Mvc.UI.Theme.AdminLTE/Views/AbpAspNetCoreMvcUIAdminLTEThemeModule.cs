...
using LQ.Abp.AspNetCore.Mvc.UI.Theme.AdminLTE.Toolbars;
...
namespace LQ.Abp.AspNetCore.Mvc.UI.Theme.AdminLTE
{
    [DependsOn(
    ...
    public class AbpAspNetCoreMvcUIAdminLTEThemeModule : AbpModule
    {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.FileSets.AddEmbedded<AbpAspNetCoreMvcUIAdminLTEThemeModule>("LQ.Abp.AspNetCore.Mvc.UI.Theme.AdminLTE");
            });
