...
public class BasicWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(BasicDomainSharedModule).Assembly,
                typeof(BasicApplicationContractsModule).Assembly,
                typeof(BasicWebModule).Assembly
            );
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<BasicWebModule>();
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<BasicApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}LQ.Basic.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<BasicWebModule>(hostingEnvironment.ContentRootPath);
            });
        }
    }
    ...
    private void ConfigureNavigationServices(IConfiguration configuration)
    {
        ...
        {
            options.MenuContributors.Add(new BasicMenuContributor(configuration));
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new BasicToolbarContributor());
        });
    }
