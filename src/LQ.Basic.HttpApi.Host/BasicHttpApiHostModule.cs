...
public class BasicHttpApiHostModule : AbpModule
{
    ...
    {
        Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "Basic:"; });
    }
            ...
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<BasicDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}LQ.Basic.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<BasicDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}LQ.Basic.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<BasicApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}LQ.Basic.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<BasicApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}LQ.Basic.Application"));
            });
        }
    }
